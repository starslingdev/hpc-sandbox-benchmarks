...
Requested target for every provider: **2 vCPU · 8 GiB RAM · 40 GB disk**. This run contains **115 metric records**
backed by **226 retained trial observations**, across **32 metrics** and

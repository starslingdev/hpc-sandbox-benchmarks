...
export const providerIdSchema = type(
	"'e2b' | 'daytona-vm' | 'daytona-container' | 'modal-gvisor' | 'modal-vm' | 'blaxel' | 'microsandbox-local' | 'microsandbox-cloud' | 'novita' | 'runloop' | 'namespace' | 'vercel' | 'runcloud' | 'cursor-cloud-agent'",
);

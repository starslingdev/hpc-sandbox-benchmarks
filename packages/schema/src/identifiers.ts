...
/** A filename- and ref-safe identity for attempts, cells, accounts and operators. */
export const evidenceIdentifierSchema = type(/^[a-zA-Z0-9][a-zA-Z0-9._-]*$/);

/** A canonical-JSON or raw-tree evidence digest. */
export const sha256DigestSchema = type(/^sha256:[a-f0-9]{64}$/);

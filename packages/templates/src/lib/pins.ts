...
export const rawPins = {
	...
	// > every sandbox. node-web-tooling/pybench/sqlite-speedtest leaves are versionless, so their
	// > bake entries stay versionless to match. (pyperformance was dropped: no registered suite or
	// > mise task runs it, and its pip-driven install inflated every bake for nothing.)
	ptsInstallTests:
		"node-web-tooling pybench sqlite-speedtest c-ray-2.0.0 compress-zstd-1.6.0 fio-2.1.0 network-loopback-1.0.1 pgbench-1.15.0 stream-1.3.4",

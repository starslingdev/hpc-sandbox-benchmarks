...
export const config = {
	...
	/** The daytona-vm account/target the adapter boots from: API key, runner target (`DAYTONA_TARGET`,
	 *  e.g. `us-west-2`), and the LINUX_VM snapshot to boot (`DAYTONA_SNAPSHOT` override, else the
	 *  version-scoped default). */
	daytonaVm: {

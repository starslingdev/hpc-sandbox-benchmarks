...
- [Rich leaderboard rendering](./leaderboard-rich-render-design.md) — how `@sandbox-benchmarks/figures` renders the leaderboard figures, and the constraints that shaped it
